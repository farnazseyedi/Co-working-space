        ...
        <footer className="relative py-40 rtl flex justify-center items-center w-full overflow-hidden">
            ...
            <div className="relative mx-auto px-4 flex flex-col items-center w-full max-w-[900px]">
                ...
                <div className="flex flex-col gap-2 text-center">
                    ...
                    <div className="text-lg opacity-90">ما اینجا بهت یاد میدیم چطوری یاد بگیری…</div>
                </div>
                    ...
                    <ul className="flex flex-wrap justify-center items-center gap-x-10 gap-y-3 text-lg">
                        {[
                            ...
                            <li key={i} className="flex items-center gap-2 group">
                                <span className="w-2 h-2 rounded-full bg-gray-300 group-hover:bg-blue-500 transition-colors"></span>
                                <Link
                                    href={item.href}
                ...
                <div className="mt-10 w-full h-0.5 bg-gray-300 mx-auto"></div>
                    ...
                    <div className="flex gap-6">
                        {socialLinks.map((social, index) => (
                            <a
                                ...
                                className="group"
                            >
                                <span className="block bg-gray-200 rounded-full p-2 group-hover:bg-blue-500 transition-colors">
                                </span>
                            </a>
                        ))}
                    </div>

"use client";
import BlueButton from "@/app/components/BlueBotton";
...
export default function Info() {
    return (
        <>
            <div className="flex mt-2 justify-center items-center text-4xl font-black">
                فراتر از یک آکادمی...
            </div>
            <div className="flex mt-2.5 flex-col md:flex-row items-center justify-center gap-8 p-4 ">

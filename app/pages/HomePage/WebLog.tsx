        ...
        <div className="w-full px-6 py-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {cards.map((card, index) => (
                    <div key={index} className="relative pb-[90px] sm:pb-[85px] lg:pb-[75px]">
                        <div className="inverted-radius rounded-(--r) bg-white shadow-xl group hover:shadow-2xl transition-shadow duration-300 ">
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-4">
                                        {card.tags.map((tag, idx) => (
                                            <span
                                                key={idx}
                                                className="bg-gray-100 text-gray-700 text-xs px-3 py-1.5 rounded-(--r) shadow-sm"
                                            >
                                                {tag}
                                            </span>
                                        ))}
                        ...
                        <div className="absolute bottom-[73px] left-[20px]">
                            <button className="w-20 h-20 bg-linear-to-r from-orange-500 to-orange-400 rounded-3xl flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300">
                                <svg className="w-6 h-6 text-white mr-1" viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M9 5L16 12L9 19"
                                        stroke="currentColor"
                                        strokeWidth="2"
